...
@section('body')
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Add test form</div>
                ...
                <div class="ibox-body">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{route('tests.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Laboratory name</label>
                            <div class="col-sm-10">
                                <select class="form-control" name="laboratory_id" id="laboratoryId" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="name" placeholder="Enter test name" required/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Test code</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="code" placeholder="Enter test code" required/>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10 ml-sm-auto">
                                <button class="btn btn-info btn-block" type="submit">Create new test</button>
                            </div>
                        </div>
                    </form>
                </div>
